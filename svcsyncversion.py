...
if __name__ == "__main__":
    ...
    parser.add_argument(dest='ranges', type=str, help="ranges")
    ...
    #Making ret = true for customize code
    ret = "true"
    ...
    if ret == "":
        ...
        jira_ids = []
        logging.info("Here is the range provided in the parameter")
        print(args.ranges)
        
        num_of_revisions = args.ranges.split(",")
        num_of_revisions = [i.strip() for i in num_of_revisions]
